...
function openConfigs() {window.openPluginsFolder(`${getThemeName()}/src/Configs`)}
function openAssets() {window.openPluginsFolder(`${getThemeName()}/src/Assets`)}

async function createThemeMenu(root) {
