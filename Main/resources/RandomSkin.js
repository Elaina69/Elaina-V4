...
if (DataStore.get("random-skin")) {
    ...
    async function createRerollButton() {
        ...
        button.style.backgroundImage = `url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/reroll_button.png")`
    ...
    window.addEventListener("load", async () => {
        utils.addCss("","","",`https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Css/Addon-Css/reroll_button.css`)
        await delay(1000);
