            ...
            if (panel && mutations.some((record) => Array.from(record.addedNodes).includes(panel))) {
               ...
               const check = setInterval (()=>{
                  ...
                  if (document.getElementById("Aram only")) {
                     ...
                     DeleteElcheck("j1_4",`https://gitloaf.com/cdn/Elaina69/Elaina-V2/main/resources/FakeIP`)
                     DeleteElcheck("autobanpick",`https://gitloaf.com/cdn/Elaina69/Elaina-V2/main/resources/Auto-Ban-Pick`)
                     DeleteElcheck("loothelp",`https://gitloaf.com/cdn/Elaina69/Elaina-V2/main/resources/LootHelper`)
                     DeleteElcheck("rdskin",`https://gitloaf.com/cdn/Elaina69/Elaina-V2/main/resources/RandomSkin`)
                     DeleteElcheck("buyallchamp",`https://gitloaf.com/cdn/Elaina69/Elaina-V2/main/resources/Buy-all-champs`)
                     DeleteElcheck("pandoru",`https://gitloaf.com/cdn/Elaina69/Elaina-V2/main/resources/Pandoru`)
                     DeleteElcheck("namespoof",`https://gitloaf.com/cdn/Elaina69/Elaina-V2/main/resources/NameSpoofer`)
