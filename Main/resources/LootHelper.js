...
if (DataStore.get("loot-helper")) {
    ...
    window.addEventListener('load', () => {
		...
		NStyle.appendChild(document.createTextNode(
			'@import url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Css/Addon-Css/LootHelper.css");:root {--OC_button:url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/button-open-chests.png");--BE_button:url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/button-blue-essence.png");--BE_hover:url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/button-blue-essence-hover.png");--BE_active:url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/button-blue-essence-click.png");--rbutton:url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/button-refresh.png");--rhover:url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/button-refresh-hover.png");--ractive:url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/button-refresh-click.png");--OC_hover:url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/button-open-chests-hover.png");--OC_active:url("https://gitloaf.com/gitcfcdn/Elaina69/Elaina-V2/main/Main/assets/Icon/Plugins-icons/button-open-chests-click.png");}'
		));
